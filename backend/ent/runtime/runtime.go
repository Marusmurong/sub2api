...
func init() {
	...
	// groupDescAllowNonClaudeCode is the schema descriptor for allow_non_claude_code field.
	groupDescAllowNonClaudeCode := groupFields[40].Descriptor()
	// group.DefaultAllowNonClaudeCode holds the default value on creation for the allow_non_claude_code field.
	group.DefaultAllowNonClaudeCode = groupDescAllowNonClaudeCode.Default.(bool)
