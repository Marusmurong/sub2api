export default {
    ...
    proxies: {
      ...
      qualityTargetIPType: '出口 IP 类型',
      qualityNetworkType: '出口类型',
      networkTypeResidential: '家庭住宅',
      networkTypeMobile: '移动网络',
      networkTypeBusiness: '商业专线',
      networkTypeHosting: '机房 IP',
      networkTypeVpn: 'VPN / 代理',
      networkTypeUnknown: '类型未知',
