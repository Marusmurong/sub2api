export default {
  ...
  payment: {
    ...
    usdtAdmin: {
      ...
      bindTitle: '手动绑定到订单',
      orderId: '订单 ID',
      forceLabel: '强制绑定（金额不一致时）',
      forceHint: '跳过金额校验。金额不符时请先确认这笔钱确实属于该订单 —— 绑错会把钱记到别人账上。',
      bindSuccess: '已绑定并入账',
      statuses: {
        UNMATCHED: '待处理',
        MATCHED: '已核销',
    ...
    usdt: {
      title: 'USDT 支付',
      scanHint: '使用支持 TRC20 的钱包扫码，或复制下方地址',
      address: '收款地址',
      rate: '参考汇率',
      orderAmount: '订单金额',
      amountToSend: '应付金额',
      exactAmountWarning: '请精确转账 {amount} USDT。金额末两位是本订单的识别码，转错金额将无法自动到账，需要人工处理。',
      networkWarning: '仅支持 {network} 网络。使用其他链转账将导致资产永久丢失，无法找回。',
      waitingConfirmation: '正在等待链上确认，通常需要 1–2 分钟',
      cancelledDesc: '订单已取消。若你已经转账，资金不会丢失，请联系客服处理。',
      expiredDesc: '订单已超时。若你已经转账，资金不会丢失 —— 到账后我们会人工为你入账，请联系客服。',
    },
    status: {
      pending: '待支付',
      paid: '已支付',
