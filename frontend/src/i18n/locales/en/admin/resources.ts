export default {
    ...
    proxies: {
      ...
      qualityTargetIPType: 'Exit IP type',
      qualityNetworkType: 'Exit type',
      networkTypeResidential: 'Residential',
      networkTypeMobile: 'Mobile',
      networkTypeBusiness: 'Business',
      networkTypeHosting: 'Datacenter',
      networkTypeVpn: 'VPN / Proxy',
