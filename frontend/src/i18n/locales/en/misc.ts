export default {
  ...
  payment: {
    ...
    usdtAdmin: {
      ...
      bind: 'Bind to order',
      ignore: 'Ignore',
      bindTitle: 'Bind deposit to an order',
      orderId: 'Order ID',
      forceLabel: 'Force bind (amount mismatch)',
      forceHint: 'Skips the amount check. Confirm this money really belongs to that order first - binding the wrong one credits somebody else.',
      bindSuccess: 'Deposit bound and credited',
      statuses: {
    ...
    usdt: {
      title: 'Pay with USDT',
      scanHint: 'Scan with any TRC20-compatible wallet, or copy the address below',
      address: 'Receiving address',
      rate: 'Reference rate',
      orderAmount: 'Order amount',
      amountToSend: 'Amount to send',
      exactAmountWarning: 'Send exactly {amount} USDT. The final two digits identify this order — a different amount cannot be credited automatically and needs manual handling.',
      networkWarning: 'Only the {network} network is supported. Sending on any other chain will lose the funds permanently.',
      waitingConfirmation: 'Waiting for on-chain confirmation, usually 1-2 minutes',
      cancelledDesc: 'Order cancelled. If you already sent the transfer, the funds are not lost - please contact support.',
      expiredDesc: 'Order timed out. If you already sent the transfer, the funds are not lost - we will credit it manually once it arrives. Please contact support.',
    },
    status: {
      pending: 'Pending',
      paid: 'Paid',
